...
{
    abstract class RadialFish : IFish
    {
        ...
        public float Radius { get { return radius[Level - 1]; } }
		public float Scale { get { return scale; } }
		public RadialFish(Int32[] requiredFood, Int32 requiredStars, Double[] timeToAction, Int32[] damage, Int32[] health , 
		                   string image,string name,Int32 id,float[] radius, float scale)
        {
